...
class SearchTest {
    ...
    val bgmClient = AsyncBgmClient("bgm211261c459e297e44", "08cc6c23fb05fd3aeb1b13c8a06a94c5", "https://bgm.kurenai.moe:18080/callback", isDebugEnabled = true);

    @Test
    fun test() {
        println(MAPPER.writeValueAsString(bgmClient.sendSync(SearchSubject("刀剑神域").apply {
            maxResults = 5
            start = 1
        })))
    }
    ...
    @Test
    fun testCharacter() {
        println(MAPPER.writeValueAsString(bgmClient.sendSync(GetSubject(6).apply {
        })))
    }
